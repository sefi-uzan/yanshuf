...
3. Create rule:
   - From capture: `yanshuf_search_captures` → `yanshuf_save_map_remote_rule(captureId=..., host=..., url=... / matchMode=... overrides optional)`
   - From scratch: `yanshuf_save_map_remote_rule(url, host, matchMode?, port?, protocol?)`
